...
all: $(SRC)/main.cpp window.o commands.o cursor.o buffer.o ncurses_interface.o
	$(G++) $(SRC)/main.cpp buffer.o commands.o cursor.o window.o ncurses_interface.o -lncurses -o text -g -I$(I)
...
test: test.o $(SRC)/bufferTest.cpp buffer.o $(SRC)/commandsTest.cpp commands.o cursor.o ncurses_interface.o
	...
	$(G++) test.o bufferTest.o commandsTest.o commands.o cursor.o buffer.o ncurses_interface.o -lncurses -o test 
	./test
